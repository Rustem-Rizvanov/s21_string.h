...
START_TEST(sprintf_40_f) {
  ...
  char str2[400];
  char *str3 = "test: %.1f!\ntest: %.2f!\ntest: %.3f!";
  double num = 000000000000000.00000000000;
  ck_assert_int_eq(sprintf(str1, str3, num, num, num),
                   s21_sprintf(str2, str3, num, num, num));
  ck_assert_pstr_eq(str1, str2);
}
...
START_TEST(sprintf_42_f) {
  ...
  char str2[400];
  char *str3 = "test: %.1f!\ntest: %.2f!\ntest: %.3f!";
  double num = -635293201236310753.6495633;
  ck_assert_int_eq(sprintf(str1, str3, num, num, num),
                   s21_sprintf(str2, str3, num, num, num));
  ck_assert_pstr_eq(str1, str2);
}
...
START_TEST(sprintf_46_f) {
  ...
  char str2[400];
  char *str3 = "test: %.1f!\ntest: %.2f!\ntest: %.3f!";
  double num = -9325781235683689988.;
  ck_assert_int_eq(sprintf(str1, str3, num, num, num),
                   s21_sprintf(str2, str3, num, num, num));
  ck_assert_pstr_eq(str1, str2);
}
