...
//             // Используем приведение к unsigned char для корректного сравнения
//         }
//     }
//     // Если все символы до n-го равны
//     return 0;
...
//     char *buffer_1 = (char *)malloc((n + 1) * sizeof(char)); // +1 для завершающего нуля
//     char *buffer_2 = (char *)malloc((n + 1) * sizeof(char)); // +1 для завершающего нуля
